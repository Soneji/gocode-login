...
if (isset($_GET['name']) && $_GET['name']!='') {
	...
	if($result->num_rows>1){
		...
		$sql="INSERT INTO `register` (`RegisterID`, `InOrOut`, `Time`, `StudentID`) VALUES (NULL, b'0', NOW(), '".$StudentID."')";
		$conn->query($sql);
		$conn->close();
?>
...
<body>
	...
	<table cellspacing="30em" id='table' class='prettytable' style="max-height: 99%; height:100%; width:100%;"><tr><td>You have been logged out<br><br>Redirecting you in 2 seconds...</td></tr></table>
</body>
</html>
